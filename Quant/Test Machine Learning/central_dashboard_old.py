...
class CentralDashboard:
    ...
    def __init__(self, 
        ...
        # Path to Results Machine Learning directory
        self.results_ml_path = os.path.join(os.path.dirname(self.base_path), "Results Machine Learning")
        ...
        logger.info(f"📁 Results ML path: {os.path.abspath(self.results_ml_path)}")
    ...
    def scan_module_results(self) -> Dict[str, Any]:
        ...
        # Search in both Test Machine Learning and Results Machine Learning directories
        search_paths = [
            os.path.join(self.base_path, "**/test_summary.json"),
            os.path.join(self.results_ml_path, "**/test_summary.json")
        ]
        ...
        for summary_file in summary_files:
            try:
                ...
                # If the module name starts with "test_results_", extract the actual module name
                if module_name.startswith("test_results_"):
                    module_name = module_name.replace("test_results_", "")
                ...
                result_files = [f for f in os.listdir(module_dir) if f.endswith(('.html', '.json', '.png', '.csv'))]
